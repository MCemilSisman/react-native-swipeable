...
global.rightD2A2 = false,
global.rightD2D1 = false,
global.leftD2A2 = false,
global.leftD2D1 = false,

global.rightD2beforeA1 = 0;
global.leftD2beforeA1 = 0;

global.isSwipingLeft = false;
global.isSwipingRight = false;
  ...
  function Swipeable() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Swipeable.__proto__ || Object.getPrototypeOf(Swipeable)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _this$props = _this.props,
          ...
          leftActionDeactivationDistance = _this$props.leftActionDeactivationDistance,
          ...
          rightActionDeactivationDistance = _this$props.rightActionDeactivationDistance,
      ...
      global.isSwipingRight = isSwipingRight;
      global.isSwipingLeft = isSwipingLeft;
      ...
      if ( (leftActionActivated || global.leftD2A2) && canSwipeRight && x >= leftActionActivationDistance) {
        if(isSwipingRight && global.flag2){
          console.log("LA2")
          global.flag1 = true; //Left A1
          global.flag2 = false;  //Left A2
          global.flag3 = false; //Left D1
          global.flag4 = true; //Left D2
          global.flag5 = true; //Right A1
          global.flag6 = true; //Right A2
          global.flag7 = true; //Right D1
          global.flag8 = true; //Right D2
          global.rightD2beforeA1 = 0;
          nextLeftActionActivated = true;
          global.leftD2A2 = false,
          global.leftD2beforeA1 = global.leftD2beforeA1 + 1;
      ...
      if (!leftActionActivated && canSwipeRight && x >= leftActionActivationDistance) {
        if(isSwipingRight && global.flag1){
          if(global.leftD2beforeA1 != 3){
            console.log("LA1")
            global.flag1 = true; //Left A1
            global.flag2 = true;  //Left A2
            global.flag3 = true; //Left D1
      ...
      if ( (leftActionActivated || global.leftD2D1) && (canSwipeRight || global.swipeCount == 1) && x < leftActionDeactivationDistance) {
        if(isSwipingLeft && global.flag3){
          console.log("LD1")
          global.flag1 = true; //Left A1
          global.flag2 = false;  //Left A2
          global.flag3 = false; //Left D1
      ...
      if (leftActionActivated && (canSwipeRight || global.swipeCount == 2) && x < leftActionDeactivationDistance) {
        if(isSwipingLeft && global.flag4){
          console.log("LD2")
          global.flag1 = true; //Left A1
          global.flag2 = true;  //Left A2
          global.flag3 = true; //Left D1
          ...
          global.rightD2beforeA1 = 0;
          nextLeftActionActivated = false;
          global.leftD2A2 = true;
          global.leftD2D1 = true;
          global.leftD2beforeA1 = 2;
          onLeftActionDeactivate2(event, gestureState, _this);
        }
      }

      if ( (rightActionActivated || global.rightD2A2 ) && canSwipeLeft && x <= -rightActionActivationDistance) {
        if(isSwipingLeft && global.flag6){
          ...
          global.rightD2A2 = false,
          global.rightD2beforeA1 = global.rightD2beforeA1 + 1;
      ...
      if ( (rightActionActivated || global.rightD2D1) && canSwipeLeft && x > -rightActionDeactivationDistance) {
        if(isSwipingRight && global.flag7){
          console.log("RD1")
          global.flag1 = true; //Left A1
          global.flag2 = true;  //Left A2
          global.flag3 = true; //Left D1
      ...
      if (rightActionActivated && canSwipeLeft && x > -rightActionDeactivationDistance) {
        if(isSwipingRight && global.flag8){
          console.log("RD2")
          global.flag1 = true; //Left A1
          global.flag2 = true;  //Left A2
          global.flag3 = true; //Left D1
          ...
          global.leftD2beforeA1 = 0;
          nextRightActionActivated = false;
          global.rightD2A2 = true;
          global.rightD2D1 = true;
          global.rightD2beforeA1 = 2;
      ...
      animationFn(pan, animationConfig).start(function () {
        ...
        var _this$props3 = _this.props,
            ...
            onLeftActionIncomplete = _this$props3.onLeftActionIncomplete,
            ...
            onRightActionIncomplete = _this$props3.onRightActionIncomplete,
        ...
        if (!leftActionActivated) {
          onLeftActionIncomplete(event, gestureState, _this);
        ...
        if (!rightActionActivated) {
          onRightActionIncomplete(event, gestureState, _this);
        }
...
Swipeable.propTypes = {
  ...
  onLeftActionIncomplete: _propTypes.PropTypes.func,
  leftActionActivationDistance: _propTypes.PropTypes.number,
  leftActionDeactivationDistance: _propTypes.PropTypes.number,
  ...
  onRightActionIncomplete: _propTypes.PropTypes.func,
  rightActionActivationDistance: _propTypes.PropTypes.number,
  rightActionDeactivationDistance: _propTypes.PropTypes.number,
...
Swipeable.defaultProps = {
  ...
  onRightActionIncomplete: noop,
  onRightActionComplete: noop,
  rightActionActivationDistance: 125,
  rightActionDeactivationDistance: 125,
